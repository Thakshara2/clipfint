  ...
  return (
    <Container className="py-20">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">About VoiceForge</h1>
        
        <div className="prose dark:prose-invert">
          <p className="text-lg text-muted-foreground mb-6">
            VoiceForge is a cutting-edge text-to-speech platform that leverages advanced AI technology to create natural-sounding voices for various applications.
          </p>
          ...
          <p className="text-muted-foreground">
            Have questions or need support? Visit our <a href="/contact" className="text-primary hover:underline">contact page</a> to get in touch with our team.
          </p>
        </div>
      </div>
    </Container>
